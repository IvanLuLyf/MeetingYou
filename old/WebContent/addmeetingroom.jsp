						...
						<div class="panel-body">
							...
							<form class="form-horizontal" role="form" action="AddMeetingRoomServlet" method="post">
								<div class="form-group">
									...
									<div class="col-lg-4">
									<input id="roomnumber" name="roomnumber" type="text" placeholder="例如：201" maxlength="10" class="form-control" required/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-4">
									<input id="roomname" name="roomname" type="text" placeholder="例如：第一会议室" maxlength="20" class="form-control" required/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-4">
									<input id="roomcapacity" name="roomcapacity" type="text" placeholder="填写一个正整数" class="form-control" required/>
									</div>
								</div>
